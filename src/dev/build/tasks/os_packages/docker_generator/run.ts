...
export async function runDockerGenerator(
  ...
  if (flags.baseImage === 'wolfi')
    baseImageName =
      'docker.elastic.co/wolfi/chainguard-base:latest@sha256:442a5663000b3d66d565e61d400b30a4638383a72d90494cfc3104b34dfb3211';
  ...
  if (flags.fips) {
    imageFlavor += '-fips';
    baseImageName =
      'docker.elastic.co/wolfi/chainguard-base-fips:latest@sha256:fa6cb6918686d555f00704265499344202cb1205054bed2263c15bece3b226ec';
  }
